	...
	<body id="top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-phone"></i><span> Phone</span>+02 01289918999</p>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-envelope-o"></i><span> Email</span><a href="mailto:Code_mize@gmail.com">Code_mize@gmail.com</a></p>
                    </div>
		...
		<nav class="navbar navbar-default templatemo-nav" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">Code Mize</a>
				</div>
    		...
    		<div class="container">
    			<div class="row">
    				<div class="col-md-offset-2 col-md-8">
    					...
    					<div class="element">
                            <div class="sub-element">Hello.</div>
                            <div class="sub-element">Code Mize can design and provid your website.</div>
                            <div class="sub-element">If you need your own website, Please contact us.</div>
                        </div>
		...
		<section id="about">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
    					<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">WE ARE <span>Code Mize</span></h2>
    				</div>
    	...
    	<section id="portfolio">
    		<div class="container">
    			<div class="row">
    				<div class="col-md-12">
    					<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s"><span>Code Mize</span> PORTFOLIO</h2>
    				</div>
    			...
    			<div class="row">
    				...
    				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
    					<address>
    						...
    						<span>our own contact info. </span>
    						<p><i class="fa fa-phone"></i> +02 01289918999</p>
    						<p><i class="fa fa-envelope-o"></i> Code_mize@gmail.com</p>
    						<p><i class="fa fa-map-marker"></i> 21, Alharm Street, Giza .</p>
    					</address>
    					<ul class="social-icon">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        Code Mize &copy; Copyright 2017.</p>
                    </div>
                </div>
            </div>
        </footer>
